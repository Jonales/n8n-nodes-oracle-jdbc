    ...
    switch (errorCode) {
      case OracleErrorCodes.CONNECTION_REFUSED:
        return {
          ...
          relatedErrors: [OracleErrorCodes.TNS_LISTENER_NOT_LISTENING, OracleErrorCodes.TNS_COULD_NOT_RESOLVE],
      ...
      case OracleErrorCodes.UNIQUE_CONSTRAINT_VIOLATED:
        return {
          ...
          relatedErrors: [OracleErrorCodes.CHECK_CONSTRAINT_VIOLATED, OracleErrorCodes.NOT_NULL_CONSTRAINT_VIOLATED],
